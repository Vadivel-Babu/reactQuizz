  ...
  return (
    <div className="max-w-[1400px] mx-auto">
      ...
      <div className="mt-5 flex mx-auto flex-col md:flex-row sm:gap-[50px] flex-wrap lg:gap-[150px] py-2 px-5">
        ...
        <div>
          <div className=" md:w-[500px] flex flex-col items-center justify-center bg-white dark:bg-navy rounded-xl py-10 px-5">
            ...
            <p className="text-grayNavy dark:text-bluish">out of 10</p>
          </div>
          <button
            onClick={() => {
              navigate("/");
